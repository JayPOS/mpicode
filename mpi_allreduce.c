...
float soma_global, dif_quad_global, desvio_padrao;
   ...
   /* Reduz todas as somas locais em uma soma global para poder
      calcular a média  */
   MPI_Allreduce(&soma_local, &soma_global, 1, MPI_FLOAT, MPI_SUM,
              MPI_COMM_WORLD);
   ...
   /* Reduz a soma global do quadrado das diferenças locais para o processo raiz
      processar e imprimir a resposta  */
   MPI_Reduce(&dif_quad_local, &dif_quad_global, 1, MPI_FLOAT,
